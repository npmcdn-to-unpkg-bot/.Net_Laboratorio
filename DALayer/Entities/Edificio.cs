...
namespace DALayer.Entities
{
    public class Edificio : Unidad
    {
        ...
        public Edificio(string nombre, string descripcion, byte[] foto, float ataque, float escudo, float efectividadAtaque, float vida, string tInicial, 
                        int incrementoT)
        {
            this.nombre = nombre;
        ...
        public SharedEntities.Entities.Edificio getShared()
        {
            ...
            return new SharedEntities.Entities.Edificio(id, descripcion, foto, ataque, escudo, efectividadAtaque, vida, nombre,
                costosS, capacidadS, tiempoInicial, incrementoTiempo);
        }
    }
}
